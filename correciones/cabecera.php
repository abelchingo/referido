...
?>
<link href="http://<?php echo $_SERVER['HTTP_HOST'];?>/css/estilosPES.css" rel="stylesheet" type="text/css">
<div align="center">
  <table border="0" cellpadding="0" cellspacing="0">
      ...
      <td width="997" height="71" align="left" valign="top"><table width="972" border="0" align="center" cellpadding="0" cellspacing="5">
          <tr>
            <td width="271" height="56" align="left" valign="top"><table width="188" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/incio.php"><img src="<?php echo BASE_REL;?>img/logo2.png" alt="logo mireferido" width="271" height="153" border="0" /></a></td>
                </tr>
            </table></td>
                  ...
                  <td width="422" height="124" align="left" valign="top" background="<?php echo BASE_REL;?>img/barra_opciones_3.png" style="background-repeat: no-repeat"><table width="404" height="93" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                              ...
                              <td height="25"><table width="298" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td width="215"><div align="center">
                                        <input name="txtEmail2" id="txtEmail2" type="text" class="opaco" size="26" style="border: 0px solid #1e1977; width:190px;" onFocus=" opacar(this.id,1); completartxt1(this.id,'INGRESAR EMAIL'); " onBlur=" opacar(this.id,0); completartxt0(this.id,'INGRESAR EMAIL');" value="INGRESAR EMAIL" />
                                    </div></td>
                                    <td width="83"><div align="right"><a href="javascript:void(null)" onclick="registrarEmail('txtEmail2','si')"><img src="http://<?php echo $_SERVER['HTTP_HOST'];?>/img/enviar1.jpg" width="75" height="29" border="0" /></a></div></td>
                                  </tr>
                              </table></td>
                            </tr>
                            <tr>
                              <td height="39"><table width="282" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td width="273"><div align="left" class="cabeceraAzul" >Recibe cupones y participa gana premios y descuentos </div></td>
                                </tr>
                              </table></td>
                            </tr>
                            <tr>
                        ...
                        <td width="83"><table width="90" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="85"><div align="center"><a href="http://www.mrreferrals.com"><img src="<?php echo BASE_REL;?>img/ver_ingles.jpg" width="54" height="35" border="0" /></a></div></td>
                          </tr>
                          <tr>
                            <td><div align="center"><span class="englisVersion">English version</span></div></td>
                          </tr>
                        </table></td>
                      </tr>
                  </table></td>
    ...
    <tr>
      <td align="left" valign="top"><table width="966" border="0" align="center" cellpadding="0" cellspacing="1">
          <tr>
            <td width="964" align="left" valign="top" background="<?php echo BASE_REL;?>img/buscar_cabecera.png" style="background-repeat: no-repeat"><table width="864" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="44"><table width="962" height="44" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="974" style="background-repeat: no-repeat"><table width="960" height="44" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="161" background="<?php echo BASE_REL;?>/img/bt_buscar_negocio_off.png"><a href="javascript:void(null);" onclick="buscar1('negocio'); enviarAbuscar(); "><img src="<?php echo BASE_REL;?>img/bt_buscar_negocio_off.png" name="bt_b_negocio" id="bt_b_negocio" width="161" height="44" border="0" /></a></td>
                              <td width="143"><div align="left"><a href="javascript:void(null);" onclick="buscar1('cupon'); enviarAbuscar();"><img id="bt_b_cupon" name="bt_b_cupon" src="<?php echo BASE_REL;?>img/bt_buscar_cupon_on.png" width="142" height="44" border="0" /></a></div></td>
                              <td width="656"><div align="right">
                                <table width="173" border="0" align="right" cellpadding="0" cellspacing="5">
                                  <tr>
                                    ...
                                    <?php if(!$sesion){?>
                                    <a href="javascript:void(null);" onclick="formRegistro('si');" ><img src="<?php echo BASE_REL;?>img/registrate.jpg" width="68" height="17" border="0" /></a><?php }else{ ?>
									<a href="<?php echo BASE_REL;?>miembros/index.php?idi=<?php echo $idioma;?>"><img src="<?php echo BASE_REL;?>img/micuenta.jpg" width="68" height="17" border="0" />
									<?php }?></a>
                                    ...
                                    <td width="117">
                                     <?php if(!$sesion){?>
                                    <a href="javascript:void(null);" onclick="formSesion('si');"><img src="<?php echo BASE_REL;?>img/btiniciarsesion.png" width="117" height="32" border="0" /></a><?php }else{ ?>
                                 <a href="<?php echo BASE_REL;?>miembros/salir.php?idi=<?php echo $idioma ?>"><img src="<?php echo BASE_REL;?>img/btcerrarsesion.png" width="110" height="30" border="0" /></a> <?php }?>
			...
			$hasta = $desde + $mostrar - 1;?>
                                  <table width="564" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <div align="center"><a href="javascript:void(null)" onclick="enviarAbuscar();"><img src="<?php echo BASE_REL;?>img/buscar1.jpg" width="91" height="29" border="0" /></a></div></td>
                                    </tr>
                                    <tr align="center" valign="middle">
                                      <td  align="center" valign="top" height=""><div align="center">
                                          <input name="txtDesc" id="txtDesc" onFocus="opacar(this.id,1); completartxt1(this.id,'DESCRIPCION,CATEGORIA,NEGOCIO');" onBlur="completartxt0(this.id,'DESCRIPCION,CATEGORIA,NEGOCIO'); opacar(this.id,0);" type="text" class="opaco" size="26" style="border: 0px solid #1e1977; width:200px;" value="<?php echo trim(@$_REQUEST["txtDesc"]);?>"  onKeyUp="activarSugerencias()" maxlength="35" autocomplete="off" onKeyDown="selSug(event)" />
                                      </div>
              	<div id="cnt_al_bq" style="border:solid 0px #B8DC7C; z-index:25">&nbsp;</div>
                                      </td>
                                      <td align="left" valign="top"><div>
                                          <input name="txtUbic" id="txtUbic" onFocus=" opacar(this.id,1); completartxt1(this.id,'ESTADO,CIUDAD,ZIP'); " onBlur=" opacar(this.id,0); completartxt0(this.id,'ESTADO,CIUDAD,ZIP');" type="text" class="opaco" size="26" style="border: 0px solid #1e1977; width:200px;" value="<?php echo @$_REQUEST["txtUbic"]?>" />
                                      </div></td>
                                    </tr>
                                  </table>
                              </form></td>
...
function mostrarSugerencias()
{
	...
	if(0 < (actual - ult_ing)) {
		xajax_listarOpcBusqueda(xajax.$("txtDesc").value, 'ES');
	}
}
...
function buscar1(tipo){
	if(tipo=="negocio"){
		document.getElementById('bt_b_negocio').src="<?php echo BASE_REL;?>img/bt_buscar_negocio_off.png";
		document.getElementById('bt_b_cupon').src="<?php echo BASE_REL;?>img/bt_buscar_cupon_on.png";
		accionbuscar='negocio';
	}
	if(tipo=="cupon"){
		document.getElementById('bt_b_negocio').src="<?php echo BASE_REL;?>img/bt_buscar_negocio_on.png";
		document.getElementById('bt_b_cupon').src="<?php echo BASE_REL;?>img/bt_buscar_cupon_off.png";
		accionbuscar='cupon';	
	}
}
...
function enviarAbuscar(){
	if(frm.txtDesc.value=='DESCRIPCION,CATEGORIA,NEGOCIO')
		frm.txtDesc.value='';
	if(frm.txtUbic.value=='ESTADO,CIUDAD,ZIP')
		frm.txtUbic.value='';
	if(accionbuscar=="cupon"){
	frm.action='<?php echo BASE_REL ;?>list_cupon.php';
	frm.tipobusqueda.value='cupon';
	}else{
	frm.action='<?php echo BASE_REL ;?>list_negocio.php';
...
completartxt0('txtDesc','DESCRIPCION,CATEGORIA,NEGOCIO');
completartxt0('txtUbic','ESTADO,CIUDAD,ZIP');
//completartxt0('txtEmail1','INGRESAR EMAIL');
//completartxt0('txtEmail2','INGRESAR EMAIL');
}
...
window.open("http://<?php echo $_SERVER['HTTP_HOST'];?>/politicas.php","","width=650,height=520");
}
function verTerminos(){
window.open("http://<?php echo $_SERVER['HTTP_HOST'];?>/terminos.php","","width=650,height=520");
}
...
function registrarEmail(obj,accion){	
	if(accion=='si'){
		...
		document.getElementById(obj).value='INGRESAR EMAIL';
		if(validarCorreo(email,5)==false||email=='INGRESAR EMAIL') {
...
function loguear()
{
	...
	if(form.txtUsuario.value == "") {
		innerHtml('msjErrorLogeo','<span style="color:#F00">Ingrese su Email</span>');		
		form.txtUsuario.focus(); 
		form.txtClave.value = "";
		return false;
	}
	if(form.txtClave.value == ""){
		innerHtml('msjErrorLogeo','<span style="color:#F00">No ha escrito su clave</span>');		
		form.txtClave.focus();
		form.txtClave.value = "";
		return false;
	}	
...
for(i=0;i<sexos.length;i++){
  	...
  	if(validarTexto(nombre,2) == false) {
		innerHtml(msj,'<span style="color:#F00">Ingrese su Nombre Correctamente</span>');		
		frm.txtNombre.focus(); 
		return false;
	}
	if(validarCorreo(email,5)==false) {
		innerHtml(msj,'<span style="color:#F00">Ingrese un email correcto</span>');		
		frm.txtEmail.focus(); 
		return false;
	}
	...
	if(validarTexto(clave,5) == false) {
		innerHtml(msj,'<span style="color:#F00">Ingrese su clave correctamente. Minimo 6 caracteres</span>');		
		frm.txtClave.focus(); 
		return false;
	}
	if(clave!=rclave){
		innerHtml(msj,'<span style="color:#F00">Clave ingresada no es igual a la otra</span>');		
		frm.txtClave.focus(); 
		return false;
	}	
	...
	if(validarTexto(zip,5) == false) {
		innerHtml(msj,'<span style="color:#F00">Ingrese un codigo postal Correcto</span>');
    	frm.txtZip.focus(); 
		return false;
	}
	if(validarTexto(sexo,1) == false) {
		innerHtml(msj,'<span style="color:#F00">Seleccione su sexo</span>');
    	return false;
	}
	if(frm_a=='RUsuario'||msj=='msjErrorRAsociado2'||msj=='msjErrorRNegocio2</span>')
	if(!terminos.checked){
		innerHtml(msj,'<span style="color:#F00">Debe aceptar los terminos y condiciones</span>');
		return false;	
	}
	...
	if(frm_a=='RNegocio')
		...
		if(msj=='msjErrorRNegocio2'){
			...
			innerHtml(msj,'<span style="color:#F00">Ingrese el nombre de su Negocio</span>');
			frm.txtNegocio.focus(); 
			return false;
			}
			if(validarTexto(ndireccion,3) == false){
			innerHtml(msj,'<span style="color:#F00">Ingrese la direccion de su negocio</span>');
			frm.txtNDireccion.focus(); 
			return false;
			}
			if(validarTexto(nciudad,3) == false){
			innerHtml(msj,'<span style="color:#F00">Ingrese la Ciudad donde queda su negocio</span>');
			frm.txtNCiudad.focus(); 
			return false;
			}
			if(validarTexto(nzip,3) == false){
			innerHtml(msj,'<span style="color:#F00">Ingrese el codigo postal de su negocio</span>');
			frm.txtNZip.focus(); 
			return false;
			}
			if(validarTexto(nestado,1) == false){
			innerHtml(msj,'<span style="color:#F00">Selecione un estado</span>');
			frm.txtNEstado.focus(); 
			return false;
			}
			if(validarTexto(nfono,3) == false){
			innerHtml(msj,'<span style="color:#F00">Ingresa el numero de Telefono de tu negocio</span>');
			frm.txtNFono.focus(); 
			return false;
			}
			/*if(validarCorreo(nemail,10) == false){
			innerHtml(msj,'<span style="color:#F00">Ingrese el correo de su negocio</span>');
			frm.txtNEmail.focus(); 
			return false;
			}*/
			if(validarTexto(ncategoria,1) == false){
			innerHtml(msj,'<span style="color:#F00">Selecione una Categoria</span>');
			frm.txtNCategoria.focus(); 
			return false;
			}
			if(validarTexto(nsubcategoria,1) == false){
			innerHtml(msj,'<span style="color:#F00">Selecione una  subcategoria</span>');
...
function lisAsociado(prefijo){
	var usu=window.open("http://<?php echo $_SERVER['HTTP_HOST'];?>/miembros/lisAsociado.php?idi=ES&Retorna="+prefijo,'Asociados','width=740,scrollbars=yes,location=no,height=600');	
}
