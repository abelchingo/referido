...
<link href='http://www.mireferido.com/css/estilosPES.css' rel='stylesheet' type='text/css' />
<style type='text/css'>
<!--
.Estilo7 {
	font-size: 16px;
...
body {
	background-image: url(http://www.mireferido.com/img/bg_PaginaES.jpg);
}
-->
</style>
</head>
...
<table width='600' height='326' border='0' cellpadding='0' cellspacing='0'>
  <tr>
    <td width='631' align='left' valign='top' background='http://www.mireferido.com/img/cupon_blanco.png' style='background-repeat: no-repeat'><div align='center'>
            ...
            <tr>
              <td height='23'><div align='right'>
                <table width='452' border='0' align='right' cellpadding='0' cellspacing='2'>
                  <tr>
                    <td width='60' class='t_det_envia Estilo15'>&nbsp;</td>
...
<textarea name="textfield" cols="100" rows="5"><?=$cadena?></textarea>
</body>
</html>
