...
$negd=@$negd[0];
 ...
 echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=lis_cupon.php">';
}
else{
 echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL=lis_cupon.php">';
}
...
<meta name="Description" content="Somos la mejor empresa de mercadeo en línea. Mireferido.com es un producto nuevo e innovador que ayudara a encontrar los mejores descuentos en cupones, a tener un trabajo a tiempo parcial o completo ganando comisiones por referenciar negocios y a promover tu negocio en las mejores plataformas de sociales como FACEBOOK, TWITTER, YOU TUBE y demás. BUSCA COMPARTE Y GANA" >-->
<meta name="keywords" content="mireferido, mi referido, mi referido.com, referido, cupones en linea,  cupones online, cupones de descuento, descuentos en cupones, directorio de negocios, directorio de negocio, directorio de negocios online, directorio de negocios en linea, publicidad para negocios, marketing para negocios, publicidad para negocios, publicidad en línea, asociados independientes, asociados, gana comisiones por referencia, gana dinero por referencia,  gana premios por referencia , facebook, twitter, youtube, busca comparte y gana.">
                    ...
                    <tr>
                      <td width="263" align="left" valign="top"><table width="188" border="0" cellspacing="3" cellpadding="0">
                        <tr>
                          ...
                          <a href="det_negocio.php?dn=<?php echo @$negd["neg_cod"] ?>">
                          <?php 
                          ...
                          ?>
							 <img src="media/negocios/logodefault2.jpg" width="180"  border="0" />  
						  <?php }?>
                 			</a>
...
<div class="fb-like-box" data-href="http://www.facebook.com/#!/pages/Mi-Referidocom/118564078232642" data-width="180" data-show-faces="true" data-stream="true" data-header="true"></div>--></td></tr></table>
                    ...
                    <tr><!--background="img/unete_club_fans.jpg"-->
                      <td align="center"><table width="180px" align="center" cellpadding="0" cellspacing="0" style="background:url(img/like2.jpg) no-repeat; "  height="198" border="0"  >
                      <tr>
                        ...
                        <td><table width="583" border="0" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr>
                                    <td class="TIT_DET_NEGOCIO"><div align="left">
                                        <table width="0" border="0" align="left" cellpadding="0" cellspacing="0">
                                          ...
                                          <tr>
                                            <td width="483" ><div class="TIT_DET_NEGOCIO" align="left" style="font-size:26px"><?php echo html_entity_decode(@$cupd["cup_titulo"]);?></div>
                                            <div align="left" class="TIT_DET_NEGOCIO" style="font-size:18px"><?php echo html_entity_decode(@$cupd["cup_subtitulo"]);?></td>
                                          </tr>
                                        </table>
                                    </div></td>
                                  </tr>
                                          ...
                                          <td width="271" align="left" valign="top"><table width="268" height="143" border="0" align="center" cellpadding="0" cellspacing="0">
                                              <tr>
                                                <td width="259" height="86"><table width="239" height="43" border="0" align="right" cellpadding="0" cellspacing="11">
                                                    ...
                                                    <tr>
                                                      <td class="TIT_DET_NEGOCIO"><div align="center"><span class="est_precio_det_cupon" style="color:#FFF;">$<?php echo @$cupd["cup_costo"];?></span></div></td>
                                                      <td>
													  ...
													  <form name="imprimircupon" id="imprimircupon" action="cupon.php" method="post">
													  ...
													  <div align="right"><a href="#" onClick="vercuponp(); return false"><img src="img/imprimir_cupon_verde.jpg" width="59" height="18" border="0" /></a></div>
                                                ...
                                                <td align="center" valign="top"><table width="166" height="57" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                      <td width="36" height="57"><table width="50" border="0" cellspacing="2" cellpadding="0">
                                                          <tr>
                                                            <td><div align="center"><span class="text_gris_negrita">Valor</span></div></td>
                                                          </tr>
                                                          <tr>
                                                      ...
                                                      <td width="65"><table width="80" border="0" cellspacing="2" cellpadding="0">
                                                          <tr>
                                                            <td><div align="center"><span class="text_gris_negrita">Descuento</span></div></td>
                                                          </tr>
                                                          <tr>
                                                      ...
                                                      <td width="57"><table width="48" border="0" align="center" cellpadding="0" cellspacing="2">
                                                          <tr>
                                                            <td><div align="center"><span class="text_gris_negrita">Ahorro</span></div></td>
                                                          </tr>
                                                          <tr>
                                                            <td><div align="center" class="TIT_DET_NEGOCIO">$<?php 
															$valor=@$cupd["cup_valor"];
                            ...
                            <tr>
                              <td align="center" valign="top" background="img/fondo_detalle.jpg" style="background-repeat: repeat-y"><table width="527" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left" valign="top"><div align="left"><span class="TIT_DET_NEGOCIO">Indicaciones</span></div></td>
                                    <td valign="top"><div align="left"><span class="TIT_DET_NEGOCIO">Especificaciones</span></div></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td width="273" align="left" valign="top"><table width="244" border="0" align="left" cellpadding="0" cellspacing="0">
                                        <tr>
                                          ...
                                          <?php echo html_entity_decode(@$cupd["cup_indicaciones"]);?>
                                          </span></div></td>
                                        </tr>
                                    </table></td>
                                  ...
                                  <tr>
                                    <td><div align="left"><span class="TIT_DET_NEGOCIO">Comparte este  Cup&oacute;n y Gana! </span></div></td>
                                    <td valign="top">&nbsp;</td>
                                  </tr>
                                  <tr>
                                    <td><div align="left">
...
<div class="addthis_toolbox addthis_default_style addthis_32x32_style" 
		...
		addthis:description="<?php echo @$cupd["cup_especificaciones"];?>">
<a class="addthis_button_preferred_1"></a>
<a class="addthis_button_preferred_2"></a>
<a class="addthis_button_preferred_3"></a>
<a class="addthis_button_preferred_4"></a>
                              ...
                              <td align="left" valign="top" background="img/fondo_detalle.jpg" style="background-repeat: repeat-y"><table width="548" border="0" align="center" cellpadding="0" cellspacing="10">
                                        ...
                                        <tr>
                                          <td width="270" align="left" valign="top"><table width="263" border="0" align="left" cellpadding="0" cellspacing="0">
                                              ...
                                              <tr>
                                                <td>
                                                <br>
                                                <span class="text_gris_detalle">
												<div align="left">                                  
                                  <p class="text_gris_negrita">Tel&eacute;fono: <a href="javascript:void(0)"><?php echo @$negd["neg_fono"];?></a></p>
                                  ...
                                  <p class="text_gris_detalle"><?php echo @$negd["neg_desc"];?></p>
										  ...
										  <td><img src="img/ranking0.jpg" width="17" height="17" /></td>
                                              ...
                                              <tr>
                                                <td><a href="det_negocio.php?dn=<?php echo @$negd["neg_cod"]; ?>"><span class="text_gris_detalle_negrita">Ver comentarios </span></a></td>
                                              </tr>
                                              <tr>
                                                <td>&nbsp;</td>
                                              </tr>
                                            ...
                                            <td><div align="left"><span class="text_gris_detalle"><strong><?php echo @$negd["neg_ciu"].', '.@$negd["est_abrev"].' '.@$negd["neg_zip"];?></strong></span></div></td>
                                              ...
                                              <tr>
                                                <td><div align="left"><span class="text_gris_detalle_negrita"><a href="det_negocio.php?dn=<?php echo @$negd["neg_cod"]; ?>" >Ir a p&aacute;gina</a> </span></div></td>
                                              </tr>
                                          </table></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          ...
                                          <!-- AddThis Button BEGIN -->
<div class="addthis_toolbox addthis_default_style addthis_32x32_style" 
		addthis:url="http://<?php echo $_SERVER['HTTP_HOST'] ?>/det_negocio.php?dn=<?php echo $negd["neg_cod"];?>"	
        addthis:title="<?php echo $negd["neg_nom"];?>"
		addthis:description="<?php echo $negd["neg_desc"];?>">
<a class="addthis_button_preferred_1"></a>
<a class="addthis_button_preferred_2"></a>
