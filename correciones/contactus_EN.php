...
function enviar(){							
	...
	if(document.fcontactos.xnombre.value==""){
		document.getElementById('alerta').innerHTML="Enter your name";
		xestatus=0;
	}else{	
		if(document.fcontactos.xempresa.value==""){
			document.getElementById('alerta').innerHTML="Enter your company";
			xestatus=0;
		}else{	
			if(document.fcontactos.xtelefono.value==""){
				document.getElementById('alerta').innerHTML="Enter your Phone";
				xestatus=0;
			}else{		
				if(document.fcontactos.xemail.value==""){
					document.getElementById('alerta').innerHTML="Enter your Email";
					xestatus=0;
				}else{	
					if(document.fcontactos.xcomentario.value==""){
						document.getElementById('alerta').innerHTML="Enter your comment";
						xestatus=0;
					}else{	
						document.getElementById('alerta').innerHTML="Sending...";					
...
function enviaremail(){
	...
	ajax.open("GET", 'enviaemail_EN.php'+"?xnom="+document.fcontactos.xnombre.value+"&xemp="+document.fcontactos.xempresa.value+"&xtel="+document.fcontactos.xtelefono.value+"&xemail="+document.fcontactos.xemail.value+"&xcomentario="+document.fcontactos.xcomentario.value,true);	
            ...
            <tr>
              <td width="427"><table width="409" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
					...
					<form name="fcontactos" id="fcomentario" method="get" action="contactus_EN.php">
					...
					<table width="427" height="574" border="0" cellpadding="0" cellspacing="13">
                        ...
                        <tr>
                          <td width="401" align="center" valign="top"><table width="361" border="0" align="center" cellpadding="0" cellspacing="3" bordercolor="#FFFFFF">
                            <tr>
                              <td width="351" class="t_que_incluye"><div align="left" class="TITULO_CAB_USUARIO"><strong>CONTAC US </strong></div></td>
                            </tr>
                            <tr>
                              <td class="t_que_incluye">&nbsp;</td>
                            </tr>
                            <tr>
                              <td class="t_que_incluye"><table width="322" border="0" align="left" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td width="84" class="t_TITULO_1"><div align="left"><strong>Address:&nbsp;</strong></div></td>
                                  <td width="238"><div align="left"><span class="t_TITULO_1"><strong> 10900 NE   8th Street Suite 1000</strong></span></div></td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <td><div align="left"><span class="t_TITULO_1"><strong> info@mrreferrals.com </strong></span></div></td>
                                </tr>
                              </table></td>
                            </tr>
                            ...
                            <tr>
                              <td class="t_que_incluye"><div align="left">Contact Form </div></td>
                            </tr>
                            <tr>
                              <td class="Estilo6"></td>
                            </tr>
                            <tr>
                              <td><table width="349" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  <td width="120" class="submenu_cuenta_usuario"><div align="left" class="t_TITULO_1">Name</div></td>
                                ...
                                <tr>
                                  <td><div align="left" class="t_TITULO_1"><strong>Company</strong></div></td>
                                ...
                                <tr>
                                  <td><div align="left" class="t_TITULO_1"><strong>Phone</strong></div></td>
                                  <td><table width="229" height="36" border="0" cellpadding="0" cellspacing="5">
                                      <tr>
                                        <td width="375" align="left" valign="top" background="img/campoformazul.jpg" style="background-repeat: no-repeat"><table width="219" border="0" cellspacing="6" cellpadding="0">
                                            <tr>
                                ...
                                <tr>
                                  <td valign="top"><div align="left" class="submenu_cuenta_usuario"><span class="t_TITULO_1"><strong>Comment</strong></span></div></td>
                        ...
                        <tr>
                          <td height="64"><div align="center">
                            <table border="0" cellspacing="5" cellpadding="0">
                              <tr>
                                <td width="77"><a href="#" onclick="enviar(); return false"><img src="img/enviar2_EN.jpg" width="75" height="29" border="0" />
