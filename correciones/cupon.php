  ...
  <tr>
    <td width="100%" align="center" valign="middle" bgcolor="#FFFFFF"><div align="center">
      ...
      <table width="600" height="326" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="631" align="left" valign="top" background="img/cupon_blanco.png" style="background-repeat: no-repeat"><div align="center">
                                    ...
                                    <td><table width="163" height="38" border="0" align="left" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td width="40" height="38"><table width="40" border="0" cellspacing="2" cellpadding="0">
                                              <tr>
                                                <td width="42"><div align="center" class="Estilo8">Valor</div></td>
                                              </tr>
                                              <tr>
                                          ...
                                          <td width="73"><table width="73" border="0" cellspacing="2" cellpadding="0">
                                              <tr>
                                                <td width="69"><div align="center" class="Estilo8"><strong>Descuento</strong></div></td>
                                              </tr>
                                              <tr>
                                                <td><div align="center" class="Estilo2">
                                                  <?=$descuento?>
                                          ...
                                          <td width="47"><table width="48" border="0" align="center" cellpadding="0" cellspacing="2">
                                              <tr>
                                                <td><div align="center" class="Estilo8"><strong>Ahorro</strong></div></td>
                                              </tr>
                                              <tr>
                                                <td><div align="center" class="Estilo2">$
                                                      <?=$ahorro?>
                  ...
                  <td align="left" valign="top"><table width="451" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="166" align="left" valign="top"><table width="443" border="0" align="left" cellpadding="0" cellspacing="8">
                            <tr>
                              <td width="436" class="t_det_envia"><div align="left" class="Estilo16">V&aacute;lido hasta
                                <?=$vencimiento?>
                              </div></td>
                            </tr>
                            <tr>
					...
					?>
                                  <span class="Estilo14"><strong>Especificaciones:</strong>
                                  <?=$especificaciones?>
                                    </span> <br />
                                <br />
                                  <?
					...
					?>
                                  <span class="Estilo14"><strong>Indicaciones:</strong>
                                  <?=$indicaciones?>
                                    </span>
                                  <?
					}
					?>
                      ...
                      <tr>
                        <td height="23"><div align="right">
                            <table width="452" border="0" align="right" cellpadding="0" cellspacing="2">
                              <tr>
                                <td width="60" class="t_det_envia Estilo15"><table width="59" height="20" border="0" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <a href="cupon_cadena.php?nomneg=<?=$nomneg?>&nomcup=<?=$nomcup?>&precio=<?=$precio?>&valor=<?=$valor?>&descuento=<?=$descuento?>&ahorro=<?=$ahorro?>&vencimiento=<?=$vencimiento?>&especificaciones=<?=$especificaciones?>&indicaciones=<?=$indicaciones?>&codigocup=<?=$codigocup?>&codigoneg=<?=$codigoneg?>" target="_blank"><td><div align="left"></div></td></a>
                                  </tr>
                                </table></td>
                                <td width="386" class="t_det_envia Estilo15"><div align="right">c&oacute;digo:
                                  <?=$codigoneg?>
                                  -
                                  <?=$codigocup?>
                                </div></td>
      ...
      <p class="t_mes_gratis"><a href="javascript:window.print()" class="submenu_cuenta_usuario"><strong>IMPRIMIR CUPON </strong></a></p>
    </div></td>
  </tr>
</table>
</body>
