...
<link href="css/estilosHES.css" rel="stylesheet" type="text/css">
          ...
          <td><table border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" valign="top"><table width="294" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      <td width="294" height="44" background="img/barra_categorias.png" style="background-repeat: no-repeat"><div align="center">
                                          <table width="238" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              <td><div align="left" class="t_TITULO_1">Descuentos Especiales</div></td>
                                            </tr>
                                          </table>
                                      </div></td>
                                    </tr>
					...
					?>
                                    <div align="center" class="t_TITULO_1"> <a href="list_cupon.php?order=Ahorro&$formaorder='DESC'" style="text-decoration:none; color:#009"><strong>Ver Mas Cupones</strong></a></div></td>
                              </tr>
                          </table></td>
                        </tr>
                      </table></td> 
